...
import { EarnVaultCompanion, IPermit2, IEarnVault, INFTPermissions } from "src/companion/EarnVaultCompanion.sol";
...
contract EarnVaultCompanionTest is Test {
  ...
  function test_increasePosition_native() public {
    ...
    vm.mockCall(address(vault), abi.encodeWithSelector(INFTPermissions.hasPermission.selector), abi.encode(true));
    // Simulate increase
