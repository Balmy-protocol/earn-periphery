...
contract CompoundV3StrategyTest is Test {
  ...
  ICometRewards private cometRewards = ICometRewards(address(6));
  ...
  CompoundV3StrategyFactory private factory;
  ...
  function setUp() public virtual {
    ...
    vm.mockCall(address(cToken), abi.encodeWithSelector(ICERC20.baseToken.selector), abi.encode(asset));
  ...
  function test_cloneStrategy() public {
    ...
    CompoundV3Strategy clone = factory.cloneStrategy(
      CompoundV3StrategyData(
  ...
  function test_cloneStrategyAndRegister() public {
    ...
    (CompoundV3Strategy clone, StrategyId strategyId_) = factory.cloneStrategyAndRegister(
      owner,
      CompoundV3StrategyData(
        vault, globalRegistry, cToken, cometRewards, validationData, guardianData, feesData, liquidityMiningData
      )
  ...
  function test_cloneStrategyWithId() public {
    ...
    vm.expectEmit(false, true, false, false);
    emit BaseStrategyFactory.StrategyCloned(IEarnBalmyStrategy(address(0)), strategyId);
    CompoundV3Strategy clone = factory.cloneStrategyWithId(
      strategyId,
      CompoundV3StrategyData(
        vault, globalRegistry, cToken, cometRewards, validationData, guardianData, feesData, liquidityMiningData
      )
  ...
  function test_clone2Strategy() public {
    ...
    address cloneAddress = factory.addressOfClone2(vault, globalRegistry, cToken, cometRewards, salt);
    vm.expectEmit();
    emit BaseStrategyFactory.StrategyCloned(IEarnBalmyStrategy(cloneAddress), StrategyIdConstants.NO_STRATEGY);
    CompoundV3Strategy clone = factory.clone2Strategy(
      CompoundV3StrategyData(
        vault, globalRegistry, cToken, cometRewards, validationData, guardianData, feesData, liquidityMiningData
      ),
      salt
  ...
  function test_clone2StrategyAndRegister() public {
    ...
    (CompoundV3Strategy clone, StrategyId strategyId_) = factory.clone2StrategyAndRegister(
      owner,
      CompoundV3StrategyData(
        vault, globalRegistry, cToken, cometRewards, validationData, guardianData, feesData, liquidityMiningData
      ),
  ...
  function test_clone2StrategyWithId() public {
    ...
    vm.expectEmit();
    emit BaseStrategyFactory.StrategyCloned(IEarnBalmyStrategy(cloneAddress), strategyId);
    CompoundV3Strategy clone = factory.clone2StrategyWithId(
      strategyId,
      CompoundV3StrategyData(
        vault, globalRegistry, cToken, cometRewards, validationData, guardianData, feesData, liquidityMiningData
      ),
  ...
  function _assertStrategyWasDeployedCorrectly(CompoundV3Strategy clone, StrategyId strategyId_) private {
    assertTrue(strategyId_ == strategyId);
    assertTrue(clone.strategyId() == strategyId);
    _assertStrategyWasDeployedCorrectly(clone);
  }

  function _assertStrategyWasDeployedCorrectly(CompoundV3Strategy clone) private {
    assertEq(address(clone.cToken()), address(cToken));
    assertEq(address(clone.cometRewards()), address(cometRewards));
    assertEq(address(clone.globalRegistry()), address(globalRegistry));
    assertEq(clone.asset(), asset);
    _assertCanReceiveNative(clone);
  }

  function _assertCanReceiveNative(CompoundV3Strategy clone) private {
