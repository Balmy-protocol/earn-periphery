...
contract EarnVaultTest is PRBTest, StdUtils {
  ...
  address public asset = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; // USDC
  ...
  function setUp() public virtual {
    ...
    mintUSDC(address(this), 1000000000 * USDC);
    IERC20(asset).approve(address(vault), 1000000000 * USDC);
  ...
  function mintUSDC(address recipient, uint256 amount) public {

    address masterMinter = IMinter(asset).masterMinter();
    vm.prank(masterMinter);
    IMinter(asset).configureMinter(address(this), amount);
    IMinter(asset).mint(recipient, amount);

  }

  function transferComp(address recipient, uint256 amount) public {

    vm.prank(0xc3d688B66703497DAA19211EEdff47f25384cdc3);
    IERC20(comp).transfer(recipient, amount);

  }

  function cloneStrategy() public returns (CompoundV2Strategy) {
    ...
    address cToken = 0x39AA39c021dfbaE8faC545936693aC917d5E7563; // cUSDC
    address comptroller = 0x3d9819210A31b4961b30EF54bE2aeD79B9c9Cd3B; // comptroller
    address comp = 0xc00e94Cb662C3520282E6f5717214004A7f26888; // comp token
  ...
  function test_createPosition_CheckRewardsWithLoss_poc_haha() public {
    ...
    strategyRegistry.deployCompoundV2Strategy(strategyTokens, address(this), IEarnStrategy(address(cloneStrategy()))); 
  ...
  function test_withdraw_CheckRewards() public {
    ...
    // @audit here
    address[] memory strategyTokens = CommonUtils.arrayOf(address(asset), address(comp));
    ...
    console.log("balances before", balancesBefore[0]);
    console.log("reward before", balancesBefore[1]);
    ...
    console.log("reward after", balancesAfter[1]);
    ...
    console.log("balance1", amountToWithdraw1);
    console.log("reward", balances1[1]);
    address recipient = address(18);
